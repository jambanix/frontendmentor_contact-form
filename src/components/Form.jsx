...
export const Form = () => {
  ...
  return (
    <form noValidate onSubmit={handleSubmit(submit)} className="grid grid-cols-1 md:grid-cols-2 bg-white p-6 gap-4 rounded-md w-full max-w-[736px] relative overflow-hidden">
      ...
      <Input error={errors.forename} {...register("forename", {required: {value: true, message: "This field is required"}})} label="First Name" className="md:col-start-1"/>
      <Input error={errors.surname} {...register("surname", {required: {value: true, message: "This field is required"}})} label="Last Name" className="md:col-start-2"/>
      <Input error={errors.email} {...register("email",{required: {value: true, message: "This field is required"}, pattern: {value: emailRegex, message: "Please enter a valid email address"}})} type="email" label="Email Address" className="md:col-span-2"/>
      ...
      <div className="flex flex-col gap-8 md:col-span-2">
        ...
        {/* Text area */}
        <TextArea error={errors.message} name="message" {...register("message", {required: {value: true, message: "This field is required"}})} label="Message" className="md:col-span-2"/>

        {/* Checkbox */}
        <Checkbox error={errors.terms} onSelect={handleAgreeButtonSelect} name="terms" label="I consent to being contacted by the team" {...register("terms", {required: {value: true, message: "To submit this form, please consent to being contacted"} })} className="md:col-span-2" />
